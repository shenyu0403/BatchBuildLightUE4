...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vertLayoutLevel = QtWidgets.QVBoxLayout()
        self.vertLayoutLevel.setObjectName("vertLayoutLevel")
        self.gridLayout_3.addLayout(self.vertLayoutLevel, 0, 0, 1, 1)
