...
class Ui_Help(object):
    def setupUi(self, Help):
        ...
        self.label_7 = QtWidgets.QLabel(self.version)
        ...
        self.label_5 = QtWidgets.QLabel(self.version)
        ...
        self.label_url_website.setTextInteractionFlags(QtCore.Qt.TextBrowserInteraction)
        self.label_url_website.setObjectName("label_url_website")
        self.gridLayout_2.addWidget(self.label_url_website, 6, 1, 1, 1)
        self.label_url_octicons = QtWidgets.QLabel(self.version)
        self.label_url_octicons.setObjectName("label_url_octicons")
        self.gridLayout_2.addWidget(self.label_url_octicons, 3, 1, 1, 1)
    ...
    def retranslateUi(self, Help):
        ...
        self.label_7.setText(_translate("Help", "Github Depot"))
        self.label_4.setText(_translate("Help", "Website :"))
        self.label_5.setText(_translate("Help", "Github\'s Icons - Octicons"))
        self.label.setText(_translate("Help", "Ressources :"))
        self.label_url_website.setText(_translate("Help", "https://github.com/stilobique/BatchBuildLightUE4"))
        self.label_url_octicons.setText(_translate("Help", "https://octicons.github.com/"))
